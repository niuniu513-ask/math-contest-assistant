...
C 题分支内部质量目标：正文（不含附录）25–30 页，通常有 20–35 个有效编号公式、12–18 幅有效图和 8–12 张核心表；这些区间用于发现内容缺口，不作为机械发布配额。页数和官方上限按当届规则显式传入，正文口径为 PDF 开始至附件前一页；不得为页数或数量目标重复内容、制造空白或加入无主张支撑的图表。
